...
# assignment must provide a state for each node
# -----------------------------
...
def enumerate_posterior(query_var, query_state, evidence):
    ...
    total = 0.0
    denom = 0.0
    # numerator (query_var fixed to query_state)
    ...
    # denominator (sum over states of query_var)
...
if __name__ == '__main__':
    ...
    # show intermediate PestPop posterior for strong case
